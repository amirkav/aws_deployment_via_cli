"""
This script is written for WSGI installations on Amazon Linux instances.
...
- start the Flask API by importing its main module.

Note on why it is recommended to set up sys.path and not PYTHONPATH:
